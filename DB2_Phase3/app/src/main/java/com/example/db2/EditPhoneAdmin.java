    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(EditPhoneAdmin.this);
                ...
                EditPhoneRequest editPhoneRequest = new EditPhoneRequest(email, newPhone, "admin", getString(R.string.url) + "EditPhone.php", responseListener);
