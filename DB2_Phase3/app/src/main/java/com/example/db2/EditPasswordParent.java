    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success){
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(EditPasswordParent.this);
                ...
                EditPasswordRequest editPasswordRequest = new EditPasswordRequest(email, newPassword, "parent", getString(R.string.url) + "EditPassword.php", responseListener);
