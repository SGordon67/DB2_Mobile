...
public class LeaveMeetingButton {
    Button editButton;
    String sEmail;
    String sName;
    String sPEmail;
    ...
    String url;
    String ment;
    public LeaveMeetingButton(final Context context, String text, String email, String name, int grade, String pEmail, String password, String phone, String myUrl, int mid, String sMent){
        sEmail = email;
        sName = name;
        sPEmail = pEmail;
        sPassword = password;
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                LeaveMeetingRequest leaveMeet = new LeaveMeetingRequest(sEmail, sMid, ment, url + "LeaveMeeting.php", responseListener);
