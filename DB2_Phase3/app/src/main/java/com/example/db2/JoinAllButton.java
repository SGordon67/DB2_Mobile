...
public class JoinAllButton {
    ...
    public JoinAllButton(final Context context, String text, String email, String name, int grade, String pEmail, String password, String phone, String myUrl){
        sEmail = email;
        sName = name;
        sPEmail = pEmail;
        sPassword = password;
            ...
            public void onClick(View v){
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            Log.d("JoinedAllMeeting", response);
                ...
                LeaveMeetingRequest leaveMeet = new LeaveMeetingRequest(sEmail, 0, "ment", url + "JoinAll.php", responseListener);
